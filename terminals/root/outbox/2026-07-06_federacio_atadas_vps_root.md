...
```
cabinet-bridge: <REDACTED — rotálva 2026-07-11 incidens után>
vps-bridge:     <REDACTED — rotálva 2026-07-11 incidens után>
```
...
```yaml
  ...
  "<REDACTED — rotálva 2026-07-11 incidens után>": "cabinet-bridge"
```
...
curl -X POST <VPS-MCP-URL>/mcp/ \
  -H "Authorization: Bearer <REDACTED — rotálva 2026-07-11 incidens után>" \
