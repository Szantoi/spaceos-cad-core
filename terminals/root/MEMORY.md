...
- **Következő (increment 3):** gazdagabb ACK + `message_status_history` audit; a könyvtáros-harvest; a Cabinet root tényleges átállítása erre az API-ra. A futó CAD/Doorstar szigetek a RÉGI dist-et futtatják — restart kell, hogy éljen rajtuk a `/api/federation`.
